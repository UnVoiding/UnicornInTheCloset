...
namespace UnityEditor
{
    ...
    //
    //     internal int _hashTimeLine = "TimeLine".GetHashCode();
    //
    ...
    //     }
    //
    //     private Material s_HandleWireMaterial;
    //     public void ApllyMaterial()
    //     {
    //         if (s_HandleWireMaterial == null) s_HandleWireMaterial = (Material)EditorGUIUtility.LoadRequired("SceneView/HandleLines.mat");
    //         s_HandleWireMaterial.SetInt(handleZTestPropertyId, (int)CompareFunction.Always);
    //         s_HandleWireMaterial.SetPass(0);
    //     }
    //
    //     private float _timeDown = 0;
    //     public bool TimeRulerButton(Rect position, out float time)
    //     {
    //         time = 0;
    //         Event e = Event.current;
    //         int id = EditorGUIUtility.GetControlID(_hashTimeLine, FocusType.Passive);
    ...
    //                         _timeDown = PixelToTime(e.mousePosition.x, drawRect);
    //                         e.Use();
    //                     }
    //                 }
    //                 break;
    ...
    //         Color lineColor = timeAreaStyles.playhead.normal.textColor;
    //         lineColor.a *= alpha;
    //         if (thickness > 1f)
    //         {
    ...
    //     private static readonly int handleZTestPropertyId = Shader.PropertyToID("_HandleZTest");
    //
    ...
    //             int hDecimals;
    //             if (frameRate != 0)
    //                 hDecimals = GetNumberOfDecimalsForMinimumDifference(1 / frameRate);
    //             else
    //                 hDecimals = GetNumberOfDecimalsForMinimumDifference(shownArea.width / drawRect.width);
    //
